...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KURUMTEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_KURUMTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KURUMTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KURUMTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KURUMTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KURUMTEMEL actions', async () => {
      const expectedActions = [
        {
