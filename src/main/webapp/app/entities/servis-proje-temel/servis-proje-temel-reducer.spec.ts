...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './servis-proje-temel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVISPROJETEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVISPROJETEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVISPROJETEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVISPROJETEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVISPROJETEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVISPROJETEMEL actions', async () => {
      const expectedActions = [
        {
