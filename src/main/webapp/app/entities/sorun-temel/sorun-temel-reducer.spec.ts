...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SORUNTEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SORUNTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SORUNTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SORUNTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SORUNTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SORUNTEMEL actions', async () => {
      const expectedActions = [
        {
