...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './servis-is.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVISIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVISIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVISIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVISIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVISIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVISIS actions', async () => {
      const expectedActions = [
        {
