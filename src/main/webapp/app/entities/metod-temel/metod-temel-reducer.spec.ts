...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_METODTEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_METODTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_METODTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_METODTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_METODTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_METODTEMEL actions', async () => {
      const expectedActions = [
        {
