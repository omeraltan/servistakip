...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './personel.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERSONEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONEL actions', async () => {
      const expectedActions = [
        {
