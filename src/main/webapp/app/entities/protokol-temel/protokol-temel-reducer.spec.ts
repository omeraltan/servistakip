...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROTOKOLTEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROTOKOLTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROTOKOLTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROTOKOLTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROTOKOLTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROTOKOLTEMEL actions', async () => {
      const expectedActions = [
        {
