...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJETEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJETEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJETEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJETEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJETEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJETEMEL actions', async () => {
      const expectedActions = [
        {
