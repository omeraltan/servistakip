...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IRTIBATTEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_IRTIBATTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IRTIBATTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IRTIBATTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IRTIBATTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IRTIBATTEMEL actions', async () => {
      const expectedActions = [
        {
