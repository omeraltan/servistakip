...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLOTEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TABLOTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TABLOTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TABLOTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TABLOTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TABLOTEMEL actions', async () => {
      const expectedActions = [
        {
