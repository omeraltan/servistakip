...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVISTEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVISTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVISTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVISTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVISTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVISTEMEL actions', async () => {
      const expectedActions = [
        {
