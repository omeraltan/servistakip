...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KLASORTEMEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_KLASORTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KLASORTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KLASORTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KLASORTEMEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KLASORTEMEL actions', async () => {
      const expectedActions = [
        {
